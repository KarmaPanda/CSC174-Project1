...
<?php include "inc/nav.php"; ?>
	<main>
		...
		<article>
			<h2>Education</h2>
			<figure>
				<img src="images/uor.jpg" alt="University of Rochester"/>
			</figure>
			...
			<section>
				...
				<figure>
					<img src="images/tottenville.jpg" alt="Tottenville High School"/>
				</figure>
			</section>
		...
		<article>
			...
			<figure>
				<a href="game.php"><img src="images/trash.png" alt="T.R.A.S.H" /></a>
			</figure>
			...
			<section>
				...
				<figure>
					<img src="images/carleton.jpg" alt="Carleton College"/>
				</figure>
			</section>
	...
	<footer>
		Taken from <a href="csc174.org/lab01/dlai2" target="_blank">csc174.org/lab01/dlai2</a>
	</footer>
